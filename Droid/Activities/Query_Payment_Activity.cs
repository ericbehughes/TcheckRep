    ...
    public class Query_Payment_Activity : AppCompatActivity
    {
        ...
        protected override void OnCreate(Bundle bundle)
        {
            ...
            mButtonPay.Click += (object sender, EventArgs args) =>
            {
                ...
                var paymentConfirmationPopUp = new Purchase_Confirmation();
            ...
            mButtonCancelQuery.Click += (object sender, EventArgs args) =>
            {
                //pull up dialog
                var transaction = FragmentManager.BeginTransaction();
                var cancelScreen = new Cancel_Activity();
        ...
        private void mButtonPay_Click(object sender, OnPurchaseEvent args)
        {
            var intent = new Intent(this, typeof (Main_Menu_Activity));
            StartActivity(intent);
            Finish();
        ...
        private void cancelScreen_mOnCancel(object sender, EventArgs e)
        {
            var intent = new Intent(this, typeof (Main_Menu_Activity));
            StartActivity(intent);
        }
