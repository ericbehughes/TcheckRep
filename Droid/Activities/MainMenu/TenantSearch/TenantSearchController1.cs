...
namespace TCheck.Droid
{
...

	{
		...
		protected override void OnCreate (Bundle bundle)
		{
			...
			mButtonDislike.Click += mDislikeButtonCLick;

			mButtonLike = FindViewById<Button>(Resource.Id.buttonLike);
			mButtonLike.Click += mLikeButtonCLick;
...
*/
		...
		void mDislikeButtonCLick (object sender, EventArgs args){
			Intent intent = new Intent (this, typeof(TenantSearchController2));
			this.StartActivity (intent);
			Finish ();
		}

		void mLikeButtonCLick (object sender, EventArgs e){
			Intent intent = new Intent (this, typeof(TenantSearchController2));
			this.StartActivity (intent);
			Finish ();
		}
