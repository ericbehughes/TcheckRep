...
namespace TCheck.Droid{
	...
	public class MainMenuController : AppCompatActivity{
		...
		private Button _btnBackgroundCheck; 
		private Button _btnReviews;
		private Button _btnReports;
		private Button _btnTenantSearch;
...
*/
		void BackgroundCheckClick (object sender, EventArgs args){
			Intent intent = new Intent (this, typeof(ApplicantInputController));
			this.StartActivity (intent);
		}

		void ReportsClick (object sender, EventArgs args){
			Intent intent = new Intent (this, typeof(ReportMainController));
			this.StartActivity (intent);
		}

		void ReviewClick (object sender, EventArgs e){
			Intent intent = new Intent (this, typeof(MainMenuController));
			this.StartActivity (intent);
		}

		void TenantSearchClick (object sender, EventArgs args){
