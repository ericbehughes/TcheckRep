        ...
        public static List<BackgroundCheck> GetAllCrew()
        {
            ...
            for (var i = 0; i < numberOfPermutations; i++)
            {
                crewList.Add(new BackgroundCheck
                {
                    ...
                    Biography =
                        "I have been able to reach the top 1% for total overall points on the teamtreehouse.com leaderboard. Their leaderboard system is based on points earned for coding challenges and has roughly 283,681 total students."
                });
                ...
                crewList.Add(new BackgroundCheck
                {
                    ...
                    PhotoResourceId = Resource.Drawable.ericAngelList,
                    Biography =
                        " have been able to reach the top 1% for total overall points on the teamtreehouse.com leaderboard. Their leaderboard system is based on points earned for coding challenges and has roughly 283,681 total students."
                });
