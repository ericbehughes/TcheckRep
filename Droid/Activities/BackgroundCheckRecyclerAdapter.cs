...
namespace RentProof.Droid
{
    ...
    {
        private readonly List<BackgroundCheck> _crewMembers;
        ...
        public override RecyclerView.ViewHolder OnCreateViewHolder(ViewGroup parent, int viewType)
        {
            ...
            var itemView = LayoutInflater.From(parent.Context)
                .Inflate(Resource.Layout.BackgroundCheck_Row, parent, false);
        ...
        public override async void OnBindViewHolder(RecyclerView.ViewHolder holder, int position)
        {
            ...
            var photoBitmap =
                await _imageManager.GetScaledDownBitmapFromResourceAsync(currentCrewMember.PhotoResourceId, 120, 120);
